 ...
 */
public class FolderAdapter extends BaseLoadAdapter {
    ...
    public FolderAdapter(Fragment mFragment){
        super(mFragment);
        mInflater = (LayoutInflater) mFragment.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
        ...
        if (holder != null) {
            if(i == 0){
                ...
                if(mFolders.size()>0){
                    ...
                    loadImage(f.cover.path,holder.cover);
                }
            }else {
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            // 显示图片
            loadImage(data.cover.path,cover);
        }
    }
